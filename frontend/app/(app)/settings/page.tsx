...
import { User as UserIcon, ShieldAlert, Lock, Trash2, Settings, Calendar } from "lucide-react";
                ...
                <CardContent className="p-10 space-y-8">
                    <div className="grid gap-8 md:grid-cols-2">
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">Username</Label>
                    ...
                    <div className="p-6 rounded-3xl bg-violet-500/[0.03] border border-violet-500/10 flex items-start gap-4">
                        ...
                        <div>
                            <p className="text-xs font-bold text-violet-600/90 leading-relaxed">
                                <span className="font-black uppercase mr-2 tracking-tighter bg-violet-500 text-white px-2 py-0.5 rounded-lg shadow-sm">Read Only</span>
                                Profile details are currently managed by the system administrator.
                                Contact support to initiate any records updates or account changes.
                            </p>
                        </div>
                    </div>
                </CardContent>
                ...
                <CardContent className="p-10">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-10">
                        <div className="max-w-md space-y-2">
                            <p className="text-xl font-black text-foreground tracking-tight">Delete Account</p>
                            <p className="text-sm font-bold text-muted-foreground/70 leading-relaxed">
                                Permanently remove your profile and all associated links. This action
                                <span className="text-red-500/80 font-black ml-1">cannot be undone</span>.
                            </p>
                        </div>
